 ...
 */
public class ByteSEH implements SerializationElementHandler {

    private static final Logger log = LoggerFactory.getLogger(ByteSEH.class);
...
//
//        private static final Logger log = LoggerFactory.getLogger(org.KasymbekovPN.Skeleton.serialization.handler.member.NumberSEH.class);
//        private static final Class<? extends Annotation> ANNOTATION = Skeleton.class;
