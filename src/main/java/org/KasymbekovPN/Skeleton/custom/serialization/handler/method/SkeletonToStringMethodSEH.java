...
public class SkeletonToStringMethodSEH extends BaseSEH {

    private static final Logger log  = LoggerFactory.getLogger(SkeletonToStringMethodSEH.class);
    ...
    public SkeletonToStringMethodSEH(AnnotationChecker annotationChecker, CollectorCheckingHandler collectorCheckingHandler) {
