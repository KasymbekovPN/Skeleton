...
public class SkeletonClassSignatureSEH extends BaseSEH {

    private static final Logger log = LoggerFactory.getLogger(SkeletonClassSignatureSEH.class);
    ...
    public SkeletonClassSignatureSEH(AnnotationChecker annotationChecker) {
