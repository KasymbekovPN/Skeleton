...
public class SkeletonClassAnnotationDataSEH extends BaseSEH {

    private static final Logger log = LoggerFactory.getLogger(SkeletonClassAnnotationDataSEH.class);
    ...
    public SkeletonClassAnnotationDataSEH(AnnotationChecker annotationChecker) {
