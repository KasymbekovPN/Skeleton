...
import org.KasymbekovPN.Skeleton.lib.utils.containerArgumentChecker.ContainerArgumentChecker;
...
public class SkeletonContainerMemberSEH extends BaseSEH {

    private static final Logger log = LoggerFactory.getLogger(SkeletonContainerMemberSEH.class);
    ...
    public SkeletonContainerMemberSEH(Class<?> specificType,
