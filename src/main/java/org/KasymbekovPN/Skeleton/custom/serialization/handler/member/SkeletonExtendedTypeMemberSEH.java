...
public class SkeletonExtendedTypeMemberSEH extends BaseSEH {

    private static final Logger log = LoggerFactory.getLogger(SkeletonExtendedTypeMemberSEH.class);
    ...
    public SkeletonExtendedTypeMemberSEH(Class<?> extendableType,
