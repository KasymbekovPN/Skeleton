...
public class SkeletonSpecificTypeMemberSEH extends BaseSEH {

    private static final Logger log = LoggerFactory.getLogger(SkeletonSpecificTypeMemberSEH.class);
    ...
    public SkeletonSpecificTypeMemberSEH(Class<?> specificType,
