package org.KasymbekovPN.Skeleton.custom.result.serialization.instance.task;
...
public class InstanceTaskResult extends BaseResultImpl implements AggregateResult {

    private final Map<String, Result> results = new HashMap<>();
    private final Result dummy;

    public InstanceTaskResult(Result dummy) {
        super();
        this.dummy = dummy;
    }
    ...
    public Result createNew() {
        return new InstanceTaskResult(dummy.createNew());
    }
}
