package org.KasymbekovPN.Skeleton.custom.result.processing.task;
...
public class NodeTaskResult extends BaseResultImpl implements AggregateResult{

    private final Map<String, Result> results = new HashMap<>();
    private final Result dummy;

    public NodeTaskResult(Result dummy) {
        super();
        this.dummy = dummy;
    }
    ...
    public Result createNew() {
        return new NodeTaskResult(dummy.createNew());
    }
}
