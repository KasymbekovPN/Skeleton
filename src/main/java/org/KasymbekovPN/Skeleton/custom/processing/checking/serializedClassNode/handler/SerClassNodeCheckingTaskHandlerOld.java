...
public class SerClassNodeCheckingTaskHandlerOld extends OldBaseContextTaskHandler<SerClassNodeContext> {

    private static final Logger log = LoggerFactory.getLogger(SerClassNodeCheckingTaskHandlerOld.class);

    private Set<String> withoutMembersPart = new HashSet<>();
    private Map<String, Set<String>> wrongTypeMembers = new HashMap<>();

    public SerClassNodeCheckingTaskHandlerOld(String id) {
        super(id);
    }

    public SerClassNodeCheckingTaskHandlerOld(String id, SimpleResult simpleResult) {
