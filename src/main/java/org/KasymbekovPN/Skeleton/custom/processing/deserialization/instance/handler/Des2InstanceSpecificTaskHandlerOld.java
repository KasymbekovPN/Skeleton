...
public class Des2InstanceSpecificTaskHandlerOld extends OldBaseContextTaskHandler<OldDes2InstanceContext> {

    private static final Logger log = LoggerFactory.getLogger(Des2InstanceSpecificTaskHandlerOld.class);

    private Object instance;
    private Set<Triple<Field, Node, ObjectNode>> members;

    public Des2InstanceSpecificTaskHandlerOld(String id) {
        super(id);
    }

    public Des2InstanceSpecificTaskHandlerOld(String id, SimpleResult simpleResult) {
    ...
    @Override
    protected void doIt(OldDes2InstanceContext context) {
