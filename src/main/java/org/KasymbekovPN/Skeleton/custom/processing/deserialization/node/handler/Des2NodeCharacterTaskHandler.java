...
public class Des2NodeCharacterTaskHandler extends BaseContextTaskHandler<Des2NodeContext> {
    public Des2NodeCharacterTaskHandler() {
    }

    public Des2NodeCharacterTaskHandler(SimpleResult simpleResult) {
        super(simpleResult);
    }
