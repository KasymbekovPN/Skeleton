...
public class SKInstanceContextOld implements InstanceContextOld {

    private final Logger log = LoggerFactory.getLogger(SKInstanceContextOld.class);

    private final ContextIds contextIds;
    private final Map<String, ObjectNode> classNodes;
    private final Collector collector;
    private final Processor<InstanceContextOld> processor;
    ...
    public SKInstanceContextOld(ContextIds contextIds,
                                Map<String, ObjectNode> classNodes,
                                Collector collector,
                                Processor<InstanceContextOld> processor,
                                Object instance,
    ...
    @Override
    public Processor<InstanceContextOld> getProcessor() {
        return processor;
    }
