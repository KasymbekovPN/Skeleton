...
public class Des2InstanceCollectionTaskHandlerOld extends OldBaseContextTaskHandler<OldDes2InstanceContext> {
    ...
    public Des2InstanceCollectionTaskHandlerOld(String id) {
        super(id);
    }

    public Des2InstanceCollectionTaskHandlerOld(String id, SimpleResult simpleResult) {
