...
import org.KasymbekovPN.Skeleton.custom.serialization.clazz.handler.member.ExtendedTypeMemberSEH;
import org.KasymbekovPN.Skeleton.custom.serialization.handler.member.classes.extended.TC0;
import org.KasymbekovPN.Skeleton.custom.serialization.handler.member.classes.extended.TC1;
...
@DisplayName("SkeletonExtendedTypeMemberSEH. Testing of:")
public class ExtendedTypeMemberSEHTest {
    private static Object[][] getDataForMemberAnnotationTesting(){
        return new Object[][]{
                {
                        TC0.class,
                        new HashMap<String, Pair>(){{
                            put("publicProperty", new Pair(Integer.class, Modifier.PUBLIC));
                            put("protectedProperty", new Pair(Double.class, Modifier.PROTECTED));
                            put("privateProperty", new Pair(Float.class, Modifier.PRIVATE));
                            put("staticProperty", new Pair(Long.class, Modifier.STATIC));
                        }},
                        true
                },
                {
                ...
                },
                {
                        ...
                        new HashMap<String, Pair>(){{
                            ...
                            put("privateProperty", new Pair(Float.class, Modifier.PRIVATE));
                            put("staticProperty", new Pair(Long.class, Modifier.STATIC));
                            put("staticPropertyNE", new Pair(Long.class, Modifier.STATIC));
                        }},
                        false
                }
        };
    ...
    private static class TestSerializer implements Serializer {
        ...
        public TestSerializer(Collector collector,
            ...
            this.handler = new ExtendedTypeMemberSEH(Number.class, ah, cch);
        }
