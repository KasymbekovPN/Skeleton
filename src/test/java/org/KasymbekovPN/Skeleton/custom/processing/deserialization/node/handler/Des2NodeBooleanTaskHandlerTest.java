...
@DisplayName("Des2NodeBooleanTaskHandler. Testing of")
public class Des2NodeBooleanTaskHandlerTest {
    ...
    void testCheckMethod() throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException, ContextStateCareTakerIsEmpty {
        Tested tested = new Tested(UHandlerIds.BOOLEAN);
    ...
    void testDoItMethod(String line, boolean value, EntityItem ei) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException, ContextStateCareTakerIsEmpty {
        Tested tested = new Tested(UHandlerIds.BOOLEAN);
        ...
        if (node.is(NodeEI.booleanEI())){
            Assertions.assertThat(((BooleanNode) node).getValue()).isEqualTo(value);
        }
    }

    private static class Tested extends Des2NodeBooleanTaskHandler{
