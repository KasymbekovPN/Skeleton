...
@DisplayName("Des2NodeStringTaskHandler. Testing of:")
public class Des2NodeStringTaskHandlerTest {
    ...
    void testCheckMethod() throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException, ContextStateCareTakerIsEmpty {
        Tested tested = new Tested(UHandlerIds.STRING);
    ...
    void testDoItMethod(String line, String value, EntityItem ei) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException, ContextStateCareTakerIsEmpty {
        Tested tested = new Tested(UHandlerIds.STRING);
        ...
        if (node.is(NodeEI.stringEI())){
            Assertions.assertThat(((StringNode) node).getValue()).isEqualTo(value);
        }
    }

    private static class Tested extends Des2NodeStringTaskHandler{
