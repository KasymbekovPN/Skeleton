...
@DisplayName("JsonNumberWritingFormatter. Testing of:")
public class JsonNumberWritingFormatterTest {
    ...
    private static Object[][] getTestData(){
        return new Object[][]{
                ...
                {new NumberNode(null, 123.45), "123.45"},
                {new ObjectNode(null), ""},
    ...
    void testGetValue(Node node, String check){
        JsonNumberWritingFormatter formatter = new JsonNumberWritingFormatter(new SKOffset(OFFSET));
