...
import org.KasymbekovPN.Skeleton.custom.processing.serialization.instance.context.SKInstanceContextOld;
...
public class UInstanceSerializationOld {
    ...
    static public OldContextProcessor<InstanceContextOld> createInstanceProcessor(){
        OLdContextTask<InstanceContextOld> task = new OLdContextTask<>(TASK_COMMON);
        ...
        OldContextProcessor<InstanceContextOld> processor = new OldContextProcessor<>();
        processor.add(task);

        return processor;
    }

    static public InstanceContextOld createInstanceContext(Map<String, ObjectNode> classNodes,
                                                           OldContextProcessor<InstanceContextOld> processor,
                                                           Object instance,
        ...
        return new SKInstanceContextOld(
                contextIds,
                classNodes,
                new SKCollector(),
                processor,
